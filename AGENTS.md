...
This repository contains Python tooling for **backtesting**, **technical analysis**, **parameter optimization**, and **live/crypto data** (e.g. Futu, Glassnode, Bybit). Goals and scope are summarized in `README.md`.
...
| `scripts/` | Top-level utilities: exchange/trade scripts (`bybit_*.py`, `prod_data.py`) |
