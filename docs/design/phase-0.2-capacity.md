...
**Date:** 2026-05-20  
**Host:** `quant-server` — EC2 `i-096f85bf84852cce3` (`52.221.3.230`), **t4g.small** (Graviton ARM)  
**Safe to add +1 container (trade worker)?** **NO** — upgrade to **t4g.medium** or split TRADE to a second host first.  
