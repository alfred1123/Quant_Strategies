...
BEGIN
    ...
    -- Fixed USING positions: $1=IN_USER_ID, $2=IN_QUEUE_STATUS_ID, $3=V_LIMIT
    ...
    V_SQL := V_SQL || ' ORDER BY q.PRIORITY ASC, q.TRANSACT_FROM_TS ASC LIMIT $3';
    ...
    RETURN QUERY EXECUTE V_SQL USING IN_USER_ID, IN_QUEUE_STATUS_ID, V_LIMIT;
